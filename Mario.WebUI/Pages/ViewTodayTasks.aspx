...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Margins="0 0 0 0" Layout="BorderLayout">
            <Items>
                <ext:Window runat="server" ID="subWindowDetail" Title="任务详细信息" Modal="true" Layout="FitLayout" Width="800" Height="520"
                                    ...
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtUpdateTime" FieldLabel="今天执行时间" runat="server" ReadOnly="true" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
