<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSystemLogs.aspx.cs" Inherits="Mario.WebUI.Pages.ViewSystemLogs" EnableViewState="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Window runat="server" ID="subWindowDetail" Title="日志详细信息" Modal="true" Layout="FitLayout" Width="600" Height="450"
                    ...
                    <Items>
                        <ext:FormPanel runat="server" ID="panelDetail" ButtonAlign="Center">
                            ...
                            <Items>
                                <ext:TextField ID="txtLogID" FieldLabel="日志号" runat="server" ReadOnly="true" LabelAlign="Right" MarginSpec="5 5 5 5"  />
                                <ext:TextField ID="txtUserName" FieldLabel="操作者" runat="server" ReadOnly="true"  LabelAlign="Right" MarginSpec="5 5 5 5"  />
                                <ext:TextField ID="txtLogTime" FieldLabel="记录时间" runat="server" ReadOnly="true"  LabelAlign="Right" MarginSpec="5 5 5 5"  />
                                <ext:TextArea ID="txtMemo" FieldLabel="详细内容" runat="server" ReadOnly="true" AutoScroll="true" Height="200"  LabelAlign="Right" MarginSpec="5 5 5 5"  />
                            </Items>
                            <Buttons>
                ...
                <ext:GridPanel ID="GridPanelLog" runat="server" Region="Center">
                    <TopBar>
                        <ext:Toolbar runat="server" AutoScroll="true">
                            <Items>
                                <ext:DateField ID="DateField1" Width="280" runat="server" Vtype="daterange" FieldLabel=" 开始日期"
                                ...
                                <ext:DateField ID="DateField2" Width="280" runat="server" Vtype="daterange" FieldLabel=" 结束日期"
                                    EnableKeyEvents="true" AllowBlank="False">
                                    <CustomConfig>
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:DateColumn runat="server" Text="记录时间" DataIndex="LogTime" Format="yyyy-MM-dd HH:mm:ss" Width="180" >
                                <Filter>
                                    <ext:DateFilter OnText="在" BeforeText="之前" AfterText="之后" />
                                </Filter>
                            </ext:DateColumn>
                            <ext:Column runat="server" Text="操作人" DataIndex="UserName" >
                                <Filter>
                                    <ext:StringFilter />
                                </Filter>
                            </ext:Column>
